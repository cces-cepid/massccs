...
double alpha_1[3][3], alpha_2[3][3], Identity[3][3], nn[3][3];
...
void Force::coulomb_induced_dipole(GasBuffer *gas, int iatom, vector<double> n, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, U;
double dx, dy, dz;
double r2, x2, y2, z2, r;
...
alpha_axial = 2.19609742;
alpha_radial = 1.51148405;
...
void Force::coulomb_induced_dipole_LC(GasBuffer *gas, int iatom, vector<double> n, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, U;
double dx, dy, dz;
double r2, x2, y2, z2, r;
...
/*
 * Compute the coulomb and induced dipole interactions with isotropy polarizability using linked-cell list
 */
